...
const ALL_NAV_ITEMS: Record<string, { icon: LucideIcon; nameKey: string }> = {
  ...
  "/nexus": { icon: GraduationCap, nameKey: "NexusLearn" },
};
    ...
    >
      ...
      >
        ...
        {user && (
          ...
          >
            <div className="flex items-center gap-2 px-2 py-2 rounded-lg bg-white dark:bg-slate-700 border border-slate-100 dark:border-slate-600">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-xs font-semibold text-slate-800 dark:text-slate-100 truncate">{user.name}</div>
            ...
            <div className="flex gap-1 mt-1">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1 py-1 rounded-md text-[10px] text-slate-500 dark:text-slate-400 hover:bg-white dark:hover:bg-slate-700 hover:text-indigo-600 dark:hover:text-indigo-400 border border-transparent hover:border-slate-100 dark:hover:border-slate-600 transition-all"
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1 py-1 rounded-md text-[10px] text-slate-500 dark:text-slate-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-500 dark:hover:text-red-400 border border-transparent hover:border-red-100 dark:hover:border-red-900 transition-all"
                title="Sign out"
              >
